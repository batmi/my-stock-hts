...
def dial_sets():
    ...
    return [
        ...
        # 0.50 은 0.40↔0.60 사이의 경계 확인용이다. 2026-08-29 재검증에서 0.60 이 MDD를
        #  전 구간에서 악화시키면서 MAR은 51%(동전던지기)에 그쳤으므로, 그 악화가 어디서
        #  시작되는지 보려면 중간값이 필요하다.
        ("F. 변동성배수 하한", "0.50",       {"cfg": {"VOLATILITY_SCALING_MIN": 0.50}}),
