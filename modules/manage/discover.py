...
# 지주회사·투자회사는 개별 사업의 추세가 희석돼 추세추종 대상으로 부적합하다.
...
def _fit_score(c):
    ...
    [주의] 감사에서 이긴 것은 '상위 500 내 무작위 확장'이지 '잘 고른 확장'이 아니다.
     이 점수는 **보기 편하도록 정렬하는 용도**일 뿐, 위쪽만 골라 담는 것이 아래쪽을
     담는 것보다 낫다는 근거는 없다. 폭을 넓히는 것이 본래 목적이다.
    """
