...
# ==========================================================
# [단일 소스] 값(현재가) 색상을 반전해야 하는 '역방향' 자산.
#  이 표의 색 문법은 빨강=시장에 유리 / 파랑=불리인데, VIX·금리·달러는 값이 오를수록
#  시장에 불리하다. 반전하지 않으면 'VIX 급등 = 빨간색(강세)'처럼 의미가 뒤집혀 읽힌다.
#  (지수명은 각자의 절대 밴드가 이미 위험도 축이라 반전 대상이 아니다)
INVERSE_VALUE_INDICES = {
    "VIX (변동성)", "V코스피200",
