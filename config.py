...
class GlobalSettings(BaseModel):
    ...
    SELL_STRATEGY: dict = {
        ...
        "BREAK_EVEN_STOP_RATE": 0.5,        # [본전 청산] 손절선을 이 값(+0.5%)으로 끌어올림
                                            #  [2026-08-04 재검증 — 현행 유지] 반납 상한을 해제하면서
                                            #   승자를 조기에 끊을 수 있는 장치는 BEP만 남았다. OFF·+2.0%와
                                            #   짝비교(25회×25종목·3년·전 스택)한 결과 둘 다 잡음 수준이다
                                            #   (수익승 13/25·13/25, MAR승 15/25·16/25). 존치 근거였던
                                            #   'fat-tail 무손상'은 대체로 유지되나, 상위10% 청산 수익이
                                            #   OFF 53.9% vs 현행 44.7%로 다소 눌린다 — 실거래 표본이 쌓이면
                                            #   재확인할 것. 지금은 신호가 약해 바꾸지 않는다.
