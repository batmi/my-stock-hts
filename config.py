...
class GlobalSettings(BaseModel):
    ...
    "MR_VOL_STRENGTH": 120.0,        # 바닥권 매수세 확인을 위한 높은 체결강도 기준 (투매 방어)
        ...
        #
        #  [2026-08-08 10년 재측정 — 10 유지 재확인 · 20회×25종목, 2년씩 5구간]
        #   같은 도구의 TS 발동 축은 10년으로 늘리자 결론이 뒤집혔으므로 이 축도 다시 쟀다.
    ...
    SELL_STRATEGY: dict = {
        ...
        #
        # [2026-08-08 검증 · tools/audit_trigger_dials.py] 10년(2016-08~2026-08, 2450거래일,
        #  41종목) 실측. **고정 10.0은 최적값이 아니다 → TS_ACTIVATION_MODE로 전환했다.**
        #
        ...
        #    잘못 읽힌다. 이 다이얼은 반드시 10년·5구간으로 재야 한다.
