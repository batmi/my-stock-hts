...
INDICES_GROUPS = {
    ...
    "2": {"name": "글로벌 지수 (Global Indices)", "indices": ["나스닥 선물", "나스닥", "S&P500", "다우존스", "러셀2000", "Japan - 닛케이", "Hong Kong - 항셍", "China - 상해종합", "Taiwan - 대만가권", "Germany - 닥스40", "Europe - 스톡스50"]},
    "3": {"name": "섹터 및 주요 지표 (Sectors & Key Indicators)", "indices": ["London - Samsung GDR", "SOX (반도체)", "VIX (변동성)"]},
